...
date: "2026-07-02"
excerpt: "Digging into the CPython data model and finding that a lot of production bugs aren't logic errors, but contracts the languages assumes you already know."
